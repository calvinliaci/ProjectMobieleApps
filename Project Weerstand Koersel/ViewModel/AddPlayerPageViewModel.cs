...
{
     public partial class AddPlayerPageViewModel : BaseViewModel
     {
        ...
        public AddPlayerPageViewModel()
        {
            Title = "Speler toevoegen";
            Image = "https://firebasestorage.googleapis.com/v0/b/project-weerstand-koersel.appspot.com/" + 
            "o/players%2FBelien%20Dries.jpg?alt=media&token=b2e714ff-e343-4433-9202-273b9ff72d2a";
        }
